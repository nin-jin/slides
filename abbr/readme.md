...
### Инвариантность не вписывается в LSP

### Бивариантность не вписывается в LSP
...
### Что ещё почитать по LSP и вариантности?

- [Теория программирования: Вариантность](https://github.com/nin-jin/HabHub/issues/22)
- [Вы препарируете труп используя SOLID](https://habr.com/ru/post/308218/)
