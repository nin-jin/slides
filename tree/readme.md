...
XML - yекогда самый популярный формат, можно сказать "технологический стандарт". Но не смотря на всю свою мощь, сейчас он изживает своё, так как является слишком сложным для современного веб-разработчика.
...
Каждый формат представляет из себя некотороую модель данных. Разные модели по разному отвечают на следующие вопросы:
...
XML основан на модели типизированных элементов в которых находится словарь атрибутов и один список вложенных типизированных узлов.
...
Модель JSON основана на том, что всё дерево состоит из нетипизированных списков и словарей.
...
Наивно было бы полагать, что двух типов узлов хватит для всего. Например, представление банального синтаксического дерева сложно назвать удобоваримым.
