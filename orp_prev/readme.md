...
# Список задач: Учёт всех зависимостей
...
> При этом важно, чтобы вычисления происходили в правильном порядке. Если мы пересортируем список, а потом перефильтруем его, то затем нам снова придётся сортировать, но уже новый результат фильтрации. Получается первую фильтрацию мы делали зря. А ведь это время, задержка и злой пользователь, крутящий мышью вокруг застывшей анимации.
...
# Список задач: Отображение лишь видимого
...
# Список задач: Примерение изменений к DOM
...
# Список задач: Прямые зависимости
...
# Принцип работы: Сразу или потом?
...
# Принцип работы: По мере увеличения глубины?
...
# Принцип работы: В порядке создания?
...
# Правильный алгоритм: Построение графа зависимостей
...
> *Все вычисления происходят лениво. Между состояниями динамически строится направленный ациклический граф зависимостей. Каждый узел знает кто от него зависит и от кого зависит он.*
...
# Покажите мне код! Отображение лишь видимого
...
# Покажите мне код! Обработка ошибок
...
> *Давайте добавим асинхронную загрузку списка задач, вместо локального его хранения, измени всего один метод - метод получения списка всех задач.*
...
# Движение данных: Двунаправленные зависимости
...
# Движение данных: "Однонаправленный" поток данных
...
# Движение данных: Двусторонние каналы
