...
> В простейшем случае компонент - это экземпляр класса, интерфейс которого состоит из **методов-акцессоров - это своего рода двусторонние каналы**, из которых можно затянуть актуальные данные и предложить новые.
