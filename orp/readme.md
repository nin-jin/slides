...
> Это - текстовая версия одноимённого выступления на [FrontendConf'17](http://frontendconf.ru/2017). Вы можете [читать её как статью](https://github.com/nin-jin/slides/tree/master/orp), либо [открыть в интерфейсе проведения презентаций](https://nin-jin.github.io/slides/orp/).
...
![SAPRUN](http://nin-jin.github.io/slides/orp/company.png)
...
![$mol](http://nin-jin.github.io/slides/orp/mol.svg)
...
[![Интернет-магазин](http://toys.hyoo.ru)](http://toys.hyoo.ru)
...
![Каталог различных игрушек](http://nin-jin.github.io/slides/orp/toys.png)
...
![Каталог с фильтром](http://nin-jin.github.io/slides/orp/toys_filtered.png)
...
![Каталог со сложным фильтром и сложной сортировкой](http://nin-jin.github.io/slides/orp/toys_sorted.png)
...
![Диаграмма всех зависимостей между состояниями](http://nin-jin.github.io/slides/orp/all_deps.png)
...
![График с линейной прогрессией](http://nin-jin.github.io/slides/orp/linear.png)
...
![График с логарифмической и линейной прогрессией](http://nin-jin.github.io/slides/orp/linear_log.png)
...
![Диаграмма вырезания видимой части списка товаров](http://nin-jin.github.io/slides/orp/only_visible.png)
...
![Перерисовывать DOM - это долго](http://nin-jin.github.io/slides/orp/render_html.png)
...
![Виртуальный дом на каждый чих - это медленно](http://nin-jin.github.io/slides/orp/render_vdom.png)
...
![Прямые зависимости. Что может быть эффективней?](http://nin-jin.github.io/slides/orp/render_orp.png)
...
![И так сойдёт!](http://nin-jin.github.io/slides/orp/not_on_my_shift.png)
...
![Объектное, Функциональное и Реактивное](http://nin-jin.github.io/slides/orp/ofr_p.png)
...
[![Интернет-магазин c падающим сервисом](http://toys.hyoo.ru/#luck=.9)](http://toys.hyoo.ru/#luck=.9)
...
![Взаимодействие пользователя с сервером через интерфейс](http://nin-jin.github.io/slides/orp/user_front_back.png)
...
![](http://nin-jin.github.io/slides/orp/angular_1.png)

# Двунаправленные зависимости: Меняем состояние виджета

![](http://nin-jin.github.io/slides/orp/angular_2.png)

# Двунаправленные зависимости: Меняем состояние страницы

![](http://nin-jin.github.io/slides/orp/angular_3.png)

# Двунаправленные зависимости: Меняем состояние модели

![](http://nin-jin.github.io/slides/orp/angular_4.png)

# Двунаправленные зависимости: Пришёл ответ от сервера

![](http://nin-jin.github.io/slides/orp/angular_5.png)
...
![](http://nin-jin.github.io/slides/orp/flux_1.png)

# Однона... что это у нас?

![](http://nin-jin.github.io/slides/orp/flux_2.png)

# Потока хоть и два, но не пересекаются

![](http://nin-jin.github.io/slides/orp/flux_3.png)
...
![](http://nin-jin.github.io/slides/orp/channels_1.png)
...
![](http://nin-jin.github.io/slides/orp/channels_2.png)
...
![](http://nin-jin.github.io/slides/orp/channels_3.png)
...
![Кавайная какашка](http://nin-jin.github.io/slides/orp/shit.png)
