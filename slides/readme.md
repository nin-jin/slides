...
А пока, предлагаю вам рассказ про веб приложение для проведения презентаций [`$hyoo_slides`](https://slides.hyoo.ru/), которое я и использую для своих выступлений. [Видеозапись его доуступна на YouTube](https://youtu.be/4giWGkd7WSQ?t=2281)). Всё, что вам нужно для его запуска - это обычный веб браузер и доступ в интернет. Далее я расскажу вам, сколько всего оно умеет, и как работает.
...
Давайте приоткроем капот и посмотрим, как устроено приложение, и как сделать своё аналогичное всего за один вечер.
