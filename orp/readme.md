...
![SAPRUN](https://nin-jin.github.io/slides/orp/company.png)
...
![$mol](https://nin-jin.github.io/slides/orp/mol.svg)
...
[![https://toys.hyoo.ru/#type=all/size=M/popular](https://toys.hyoo.ru/#type=all/size=M/popular)](https://toys.hyoo.ru/#type=all/size=M/popular)
...
![Каталог различных игрушек](https://nin-jin.github.io/slides/orp/toys.png)
...
![Каталог с фильтром](https://nin-jin.github.io/slides/orp/toys_filtered.png)
...
![Каталог со сложным фильтром и сложной сортировкой](https://nin-jin.github.io/slides/orp/toys_sorted.png)
...
![Диаграмма всех зависимостей между состояниями](https://nin-jin.github.io/slides/orp/all_deps.png)
...
![График с линейной прогрессией](https://nin-jin.github.io/slides/orp/linear.png)
...
![График с логарифмической и линейной прогрессией](https://nin-jin.github.io/slides/orp/linear_log.png)
...
![Диаграмма вырезания видимой части списка товаров](https://nin-jin.github.io/slides/orp/only_visible.png)
...
![Перерисовывать DOM - это долго](https://nin-jin.github.io/slides/orp/render_html.png)
...
![Виртуальный дом на каждый чих - это медленно](https://nin-jin.github.io/slides/orp/render_vdom.png)
...
![Прямые зависимости. Что может быть эффективней?](https://nin-jin.github.io/slides/orp/render_orp.png)
...
![И так сойдёт!](https://nin-jin.github.io/slides/orp/not_on_my_shift.png)
...
[![nin-jin.github.io/sierpinski/stack.html](https://nin-jin.github.io/sierpinski/stack.html)](https://nin-jin.github.io/sierpinski/stack.html)
...
[![mol.js.org/perf/sierp/-](https://mol.js.org/perf/sierp/-)](https://mol.js.org/perf/sierp/-)
...
![Объектное, Функциональное и Реактивное](https://nin-jin.github.io/slides/orp/ofr_p.png)
...
[![https://toys.hyoo.ru/#luck=.9/type=Виброколонка/size=M](https://toys.hyoo.ru/#luck=.9/type=Виброколонка/size=M)](https://toys.hyoo.ru/#luck=.9/type=Виброколонка/size=M)
...
![Взаимодействие пользователя с сервером через интерфейс](https://nin-jin.github.io/slides/orp/user_front_back.png)
...
![](https://nin-jin.github.io/slides/orp/angular_1.png)

# Двунаправленные зависимости: Меняем состояние виджета

![](https://nin-jin.github.io/slides/orp/angular_2.png)

# Двунаправленные зависимости: Меняем состояние страницы

![](https://nin-jin.github.io/slides/orp/angular_3.png)

# Двунаправленные зависимости: Меняем состояние модели

![](https://nin-jin.github.io/slides/orp/angular_4.png)

# Двунаправленные зависимости: Пришёл ответ от сервера

![](https://nin-jin.github.io/slides/orp/angular_5.png)
...
![](https://nin-jin.github.io/slides/orp/flux_1.png)

# Однона... что это у нас?

![](https://nin-jin.github.io/slides/orp/flux_2.png)

# Потока хоть и два, но не пересекаются

![](https://nin-jin.github.io/slides/orp/flux_3.png)
...
![](https://nin-jin.github.io/slides/orp/channels_1.png)
...
![](https://nin-jin.github.io/slides/orp/channels_2.png)
...
![](https://nin-jin.github.io/slides/orp/channels_3.png)
...
![Кавайная какашка](https://nin-jin.github.io/slides/orp/shit.png)
...
- Реализации ОРП: [$mol_mem](https://github.com/eigenmethod/mol/tree/master/mem), [lom_atom](https://github.com/zerkalica/lom_atom), [VueJS](http://vuejs.org), [MobX](https://mobx.js.org), [CellX](https://github.com/Riim/cellx), [KnockOut](http://knockoutjs.com)
