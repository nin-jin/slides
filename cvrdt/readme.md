...
Может быть рассинхронизация. У кого часы отстают не может изменить данные внесённые тем, кого часы спешат.

### 🕒 Time: Counter

Злодей может задать максимальное значение счётчика и заблокировать тем самым изменение значения.
