...
Может быть рассинхронизация. У кого часы отстают не может изменить данные внесённые тем, у кого часы спешат (хотя, всегда можно прибавить единичку к его времени). Хранить реальное время всё равно нужно с прикладной точки зрения. Более поздние по времени изменения обычно более актуальные.
