...
Двусвязный список элементов, идентифицируемых логическими часами, которые растут пропорционально размеру вставляемого контента. Это позволяет последовательные вставки объединять в один узел и потом разъединять в любой момент.
...
| RGA         |            |             | ✅ Relative |           |              |            |
| WOOT        |            |             | ✅ Relative |           |              |            |
| YATA        | 🚩 Counter |             | ✅ Relative |           | 🚩 Sequence |            |
| TreeDoc     |            |             | 🚩 Absolute |           |              |            |
| LSEQ        |            |             | 🚩 Absolute |           |              |            |
| Logoot      |            |             | 🚩 Absolute |           |              |            |
