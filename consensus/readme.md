...
Вы возможно спросите меня: "Кто все эти люди и при чём тут компьютеры?". Что ж, тоит пояснить, что в распределённых системах наступление - это применение изменений, а отступление - это их откат.
