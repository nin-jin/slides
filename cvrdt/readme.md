...
Logoot Похоже на переусложнённый LSEQ. Пока не понятно в чём суть.
TreeDoc Похоже на хранение списка в виде бинарного дерева. Каждая позиция идентифицируется последовательностью бит.
