...
![Низкая отзывчивость](//nin-jin.github.io/slides/fibers/low-fps.gif)
...
![Нельзя отменить](//nin-jin.github.io/slides/fibers/no-escape.jpg)
...
![Крутая тачка](//nin-jin.github.io/slides/fibers/lotus.jpeg)
...
![Быстрые ждут медленных](//nin-jin.github.io/slides/fibers/no-concurrency.gif)
...
![Логика работы с Workers](//nin-jin.github.io/slides/fibers/worker-logic.png)
...
![(Де)сериализация](//nin-jin.github.io/slides/fibers/de-serialization.jpg)
...
![Очереди сообщений](//nin-jin.github.io/slides/fibers/async-only.png)
...
![Остановите это!](//nin-jin.github.io/slides/fibers/stop.jpg)
...
![Хитрая логика React Fiber](//nin-jin.github.io/slides/fibers/react-logic.png)
...
![React Everywere!](//nin-jin.github.io/slides/fibers/react-everywhere.jpg)
...
![Не так быстро!](//nin-jin.github.io/slides/fibers/react-only.gif)
...
![Маркетинговая ловушка](//nin-jin.github.io/slides/fibers/react-trap.jpg)
...
![Вся боль отладки](//nin-jin.github.io/slides/fibers/react-debug.jpg)
...
![flame charts](//nin-jin.github.io/slides/fibers/flame-chart.png)
...
![Типичная диаграмма исполнения](//nin-jin.github.io/slides/fibers/sync-0.svg)
...
![Исполнение без квантизации](//nin-jin.github.io/slides/fibers/sync-1.svg)
...
![Заполнение кешей](//nin-jin.github.io/slides/fibers/cache-1.svg)
...
![Реиспользование кешей](//nin-jin.github.io/slides/fibers/cache-2.svg)
...
![заполнение идемпотентных кешей](//nin-jin.github.io/slides/fibers/idemp-1.svg)
...
![Реиспользование идемпотентных кешей](//nin-jin.github.io/slides/fibers/idemp-2.svg)
...
![Бессодержательный стектрейс](//nin-jin.github.io/slides/fibers/react-stack.png)
...
![Содержательный стектрейс](//nin-jin.github.io/slides/fibers/fiber-stack.png)
...
![Быстрые и медленные запросы](//nin-jin.github.io/slides/fibers/server-chart.png)
...
![Обратная связь](//nin-jin.github.io/slides/fibers/call-back.jpg)
