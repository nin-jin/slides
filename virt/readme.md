...
[Статья на Хабре](https://habr.com/post/522578). Мобильная версия. Меньше 200 комментариев без самой статьи рендерятся на VueJS.

![](https://i.imgur.com/ZABkEx6.png)

Примерно то же самое на $mol. Отображается и статья, и комментарии. 
