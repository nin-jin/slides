...
![](https://github.com/nin-jin/slides/raw/master/reactivity/reactivity-reactivity.svg)
...
![](https://github.com/nin-jin/slides/raw/master/reactivity/reactivity-interactive.svg)
...
![](https://github.com/nin-jin/slides/raw/master/reactivity/reactivity-reactive.svg)
...
![](https://github.com/nin-jin/slides/raw/master/reactivity/reactivity-states.svg)
...
![](https://github.com/nin-jin/slides/raw/master/reactivity/reactivity-actions.svg)
...
![](https://github.com/nin-jin/slides/raw/master/reactivity/reactivity-reactions.svg)
...
![](https://github.com/nin-jin/slides/raw/master/reactivity/reactivity-invariants.svg)
...
![](https://github.com/nin-jin/slides/raw/master/reactivity/reactivity-cascade.svg)
...
![](https://github.com/nin-jin/slides/raw/master/reactivity/reactivity-runtime.svg)
...
![](https://github.com/nin-jin/slides/raw/master/reactivity/reactivity-snowboll.svg)
...
![](https://github.com/nin-jin/slides/raw/master/reactivity/reactivity-stable.svg)
...
Или другой пример: я сейчас работаю над новой реализацией реактивности. И пока летел вчера на самолёте, мидитировал над этой табличкой. В результате, я сообразил, как уменьшить потребление памяти в 2 раза, превратив объект с двумя массивами в.. просто один массив. Разумеется, мне для этого потребовалось так не модное сейчас наследование.
...
![](https://github.com/nin-jin/slides/raw/master/reactivity/reactivity-push.svg)
...
![](https://github.com/nin-jin/slides/raw/master/reactivity/reactivity-pull.svg)
...
![](https://github.com/nin-jin/slides/raw/master/reactivity/reactivity-instant.svg)
...
![](https://github.com/nin-jin/slides/raw/master/reactivity/reactivity-defer.svg)
...
![](https://github.com/nin-jin/slides/raw/master/reactivity/reactivity-lazy.svg)
...
![](https://github.com/nin-jin/slides/raw/master/reactivity/reactivity-order-subscribe.svg)
...
![](https://github.com/nin-jin/slides/raw/master/reactivity/reactivity-order-event.svg)
...
![](https://github.com/nin-jin/slides/raw/master/reactivity/reactivity-order-deep.svg)
...
![](https://github.com/nin-jin/slides/raw/master/reactivity/reactivity-order-code.svg)
...
![](https://github.com/nin-jin/slides/raw/master/reactivity/reactivity-manual.svg)
...
![](https://github.com/nin-jin/slides/raw/master/reactivity/reactivity-auto.svg)
...
Ну и в сторонке стоит лагерь тех, кто просто знают как оно работает и используют это знание с пользой. Ведь как известно: любая достаточно развитая технология неотличима от магии.. для непосвящённого человека.
...
![](https://github.com/nin-jin/slides/raw/master/reactivity/reactivity-error-unstable.svg)
...
![](https://github.com/nin-jin/slides/raw/master/reactivity/reactivity-error-stop.svg)
...
![](https://github.com/nin-jin/slides/raw/master/reactivity/reactivity-error-revert.svg)
...
![](https://github.com/nin-jin/slides/raw/master/reactivity/reactivity-error-store.svg)
...
![](https://github.com/nin-jin/slides/raw/master/reactivity/reactivity-cycle-unreal.svg)
...
![](https://github.com/nin-jin/slides/raw/master/reactivity/reactivity-cycle-allow.svg)
...
![](https://github.com/nin-jin/slides/raw/master/reactivity/reactivity-cycle-limbo.svg)
...
![](https://github.com/nin-jin/slides/raw/master/reactivity/reactivity-cycle-fail.svg)
...
Далее рассматриваем лишь поведение по умолчанию и рекомендуемый автором стиль кода. Понятное дело, что всегда можно как-то обойти проблемы. Где-то поведение можно поменять параметром конфига. Где-то нужно не забывать писать дополнительный код тут и там. Где-то придумывать адские костыли. В где-то вообще придётся отказаться от одной библиотеки, и прикрутить сбоку другую.

Однао, важно понимать, что автор библиотеки, даже если он глубоко не прав, скорее всего имеет большую экспертизу, чем обычный прикладной разработчик, в этой теме вообще и своей библиотеке в частности. Поэтому большинство кода с её помощью будет написано в каноничном стиле, рассчитанном на поведение по умолчанию. А любое отхождение от дефолта потребует дополнительного кода, который надо не забыть написать и потратить время, чтобы написать его правильно.
...
Дальнейшее сревнение, полезно не столько для того, чтобы понимать что лучше. Но и для того, чтобы понимать, к чему нужно быть готовым, затевая проект на той или иной технологии. Какие-то аспекты могут быть для вас совершенно не важными, некоторые оказаться *шоу-стоперами*, а некоторые можно легко обойти, и хорошо бы заранее подложить себе соломки, чтобы не заниматься потом мучительной отладкой и оптимизацией.
...
Пока я готовил этот материал, побеждал, как обычно, $mol. Но за пару дней CellX вырвался таки вперёд. Ну да не страшно, я всё-равно пока не рекомендую завязываться на $mol_atom2, ибо готовлю новую реализацию основанную на [Auto Wire JS Proposal](https://gist.github.com/nin-jin/6b9765fb9d0d50c2e1d37689008f5357), который позволяет разным реактивным библиотекам взаимодействовать друг с другом и с нативным браузерным API через единые интерфейсы.

Стоит отметить, чтот сам по себе RxJX не про реактивность. Он, в основе своей, про контроль потока исполнения. Однако, с его помощью можно описывать инварианты, связывающие состояния, и тогда мы получаем реактивную систему.
...
У Артёма (автора Reatom) есть интересный проект по классификации стейт-менеджеров с помощью тестов. Это чуть более широкая тема, так как, например, Redux - это стейт-менеджер, но он не реактивный. Это просто транзакционное изменение дерева состояний и всё, никаких инвариантов между состояниями. Если вас заинтересовала эта тема, то подключайтесь к написанию тестов. Думаю это в персективе должен стать очен полезным проектом для всего комьюнити.
...
Наконец, пара моих выступлений разбирающих преимущества ОРП и механику реализации асинхронных инвариантов, помогут ещё глубже закопаться в тему.

# Хотите добавки?

Для тех, кто добрался до конца, но ещё не устал, могу предложить глянуть так же и дискуссию о менеджерах состояний, которая развернулась после моего выступления, между мной и Сергеем Совой, мейнтейнером Effector-а..
...
Вот уже 7 лет я активно делюсь знаниями, идеями, пилю оупенсорс. И каждый мой материал - это оригинальная, и порой радикальная, идея, проверенная на практике. Так что стоит ознакомиться со всем этим, даже если не планируете использовать.
...
Если вы найдёте мою работу полезной, то поблагодарить меня можно задонатив или даже запатронив..
...
У нас, в гильдии HyOO, много интересных проектов, которые должны перевернуть мир. Так что самый ценный вклад, который вы можете внести, - это даже не деньги, а участие в проектах, что ускорит их развитие. Мы хотим сделать экосистему тесно интегрированных веб-сервисов, использующих самые передовые и дешёвые технологии. И потеснить оупенсорсом нынешних интернет-гигантов. Присоединяйтесь к нашей маленькой революции!
