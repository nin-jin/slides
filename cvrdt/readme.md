...
Двусвязный список элементов, идентифицируемых логическими часами. Последовательные вставки могут быть объединены в один узел и разъединены в любой момент.
