...
![Каталог со сложным фильтром](toys_filtered.png)
...
![Взаимодействие пользователя с сервером через интерфейс](user_front_back.svg)
...
![Двусторонняя коммуникация с единым источником истины](props_abstraction.svg)
...
* [$mol_mem](https://github.com/eigenmethod/mol/tree/master/mem)
