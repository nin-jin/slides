...
> Для настройки вложенного мы просто связываем его свойтва с нашими таким образом, что **оба объекта начинаютс работать с одним и тем же состоянием**, что избавляет от необходимости синхронизировать состояния, как это делает Ангуляр.
