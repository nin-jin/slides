...
Здравствуйте, меня зовут Дмитрий Карловский. А вы на канале [Core Dump](https://habr.com/ru/post/519582/), где мы берём разные темы из компьютерной науки и деконструируем их по полочкам.
...
В далёком 1988 году Бертран Мейер сформулировал свой принцип написания объектно ориентированного кода под названием "Принцип открытости/закрытости".

> [Open–Closed Principle](https://ru.wikipedia.org/wiki/%D0%9F%D1%80%D0%B8%D0%BD%D1%86%D0%B8%D0%BF_%D0%BE%D1%82%D0%BA%D1%80%D1%8B%D1%82%D0%BE%D1%81%D1%82%D0%B8/%D0%B7%D0%B0%D0%BA%D1%80%D1%8B%D1%82%D0%BE%D1%81%D1%82%D0%B8)

Вкратце, он звучит так: "программные сущности должны быть открыты для расширения, но закрыты для изменения".
