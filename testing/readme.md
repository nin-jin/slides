...
Вы можете читать её как статью, а можете [открыть в интерфейсе проведения презентаций](https://nin-jin.github.io/slides/testing/).
...
2. Интеграционные писать сложно и не понятно как.
...
*Диаграммой нарисовать. Фактически это правильная организация компонентных тестов.*
...
*Про используем компоненты как в реальном коде. Привести пример теста.*
