...
Можно написать утилиты, которые бы позволили просто и эффективно обрабатывать такие логи. Например, прочитаем лог, выберем из сообщений лишь интересные нам поля и выведем их табличкой.
...
Или предварительно отфильтруем по значению одного из полей. 
